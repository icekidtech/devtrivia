	...
	},
	{
		...
		questions: [
			...
			},
			{
				...
				answer: "We offer Classic Quiz (Kahoot-style), Speed Round, Tournament Mode, Solo Practice, and Team Battles. Each mode offers unique challenges and rewards!",
			},
			{
				question: "How is scoring calculated?",
				answer: "Points are awarded based on correctness and speed. Faster correct answers earn more points. Bonus multipliers are available for streaks and special achievements.",
			},
			{
				question: "Can I play with friends privately?",
				answer: "Yes! Create private rooms and share the PIN with your friends. Perfect for study groups, family game nights, or team building activities.",
			},
		],
	},
	{
		category: "Rewards & Web3",
		questions: [
			{
				question: "What are NFT achievements?",
				answer: "NFT achievements are unique digital collectibles you earn by reaching milestones, winning tournaments, or completing special challenges. They're yours forever on the blockchain!",
			},
			{
	...
	},
	{
		...
		questions: [
			...
			},
			{
				...
				answer: "Yes, you can delete your account at any time from your account settings. Note that this action is permanent and cannot be undone. Your quiz data and progress will be lost.",
			},
			{
				question: "How is my data protected?",
				answer: "We use industry-standard encryption and security measures to protect your data. We never sell your personal information and only collect what's necessary for the best experience.",
			},
			{
				question: "Can I change my username?",
				answer: "Yes! You can change your username once every 30 days from your profile settings. Choose wisely as frequent changes aren't allowed to maintain community recognition.",
			},
		],
	},
	{
			...
			<div className="max-w-4xl mx-auto">
				...
				<div className="text-center mb-16">
					...
					<p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
						Find answers to common questions about DevTrivia. Can&apos;t find what
						you&apos;re looking for?{" "}
						<a
							href="/contact"
